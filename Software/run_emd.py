                ...
                if args["assignLabel"]:
                    for node in tree.traverse_preorder():
                        if not node.is_leaf():
                            ...
                            nodeIdx += 1                
                tau,omega,phi = EM_date(tree,smpl_times,input_omega=omega,root_age=rootAge,s=seqLen,refTreeFile=refTreeFile,k=k,fixed_phi=args["fixedPhi"],fixed_tau=False,pseudo=pseudo,trueTreeFile=trueTreeFile,init_rate_distr=init_rate_distr)
